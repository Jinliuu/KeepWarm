...
public class ItemDragHandlerTest {

	[Test]
	public void ItemDragHandlerTestSimplePasses() {
	...
	[UnityTest]
	public IEnumerator ItemDragHandlerTestOnDrag() {
        // Use the Assert class to test conditions.
    ...
    [UnityTest]
    public IEnumerator ItemDragHandlerTestOnEndDrag()
    {
        // Use the Assert class to test conditions.
        // yield to skip a frame
        GameObject item1 = new GameObject();
